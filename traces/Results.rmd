...
```{r exp-iperf-bandwidth-all-box, fig.width=3, fig.height=2}
d <- data_iperf %>%
  filter(is.na(n))
...
```{r exp-hand-cpu-util-all-box, fig.width = 3, fig.height = 1.2}
d <- data_logcat_vrapi %>%
  filter(ts > 5) %>%
  filter(ts <= 600) %>%
  filter(a == "wordle") %>%
...
```{r exp-hand-cpu-level-all-box, fig.width = 3, fig.height = 1.2}
d <- data_logcat_vrapi %>%
  filter(ts > 5) %>%
  filter(ts <= 600) %>%
  filter(a == "wordle") %>%
...
```{r exp-hand-gpu-util-all-box, fig.width = 3, fig.height = 1.2}
d <- data_logcat_vrapi %>%
  filter(ts > 5) %>%
  filter(ts <= 600) %>%
  filter(a == "wordle") %>%
...
```{r exp-hand-gpu-level-all-box, fig.width = 3, fig.height = 1.2}
d <- data_logcat_vrapi %>%
  filter(ts > 5) %>%
  filter(ts <= 600) %>%
  filter(a == "wordle") %>%
...
```{r exp-hand-battery-power-all-box, fig.width=3, fig.height=1.2}
d <- data_batterymanager_companion %>%
  filter(ts > 5) %>%
  filter(ts <= 600) %>%
  filter(a == "wordle") %>%
