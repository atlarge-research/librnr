...
The traces available in this folder contain measurements of resource consumption of a Meta Quest 3 while in on a
KLM Boeing 787-10 Dreamliner flight from Amsterdam to San Fransisco.
The headset is connected to the on-board WiFi and used to browse the Web.
On this aircraft, KLM only offers the _surfing_ network package. The _streaming_ package is unavailable on this flight.
Through our real-world experiment, we confirm that streaming applications (Netflix, YouTube) failed to load while
